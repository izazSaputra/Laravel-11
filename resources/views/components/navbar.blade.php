    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="max-w-screen-xl px-4 mx-auto lg:px-4 w-full">
                    <!-- Start coding here -->
                    <div class="relative dark:bg-gray-800 sm:rounded-lg">
                        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:space-y-0">
                                ...
                                <div class="flex items-center w-full space-x-3 md:w-auto">
                                    ...
                                    <div id="actionsDropdown"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <x-nav-link :active="request()->is('posts')" href="/posts">Report</x-nav-link>
                                            </li>
                                            @auth
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="flex items-center lg:order-2 px-4">
                        <a href="/login""
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            tabindex="-1">
                            @if (Auth::check())
                                <a href="" class="block px-4 py-2 text-sm text-gray-700 font-bold"
                                    role="menuitem" tabindex="-1" id="user-menu-item-0">{{ Auth::user()->name }}</a>
                                <a href="" class="block px-4 py-2 text-sm text-gray-700 font-bold"
                                    role="menuitem" tabindex="-1"
                                    id="user-menu-item-0">{{ Auth::user()->username }}</a>
                            @else
                                <a href="/login" class="block px-4 py-2 text-sm text-gray-700 font-bold"
                                ...
                                <a href="/logout" class="block px-4 py-2 text-sm text-gray-700 font-bold"
                                    role="menuitem" tabindex="-1" id="user-menu-item-0">
                                    Logout
                                </a>
                            @endif
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Izaz Saputra</div>
                    <div class="text-sm font-medium leading-none text-gray-400">izazsqputra@gmail.com</div>
                </div>
                <button type="button"
